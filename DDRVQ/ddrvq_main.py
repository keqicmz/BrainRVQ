...
from engine_for_ddrvq import evaluate, train_one_epoch, calculate_codebook_usage
from utils import NativeScalerWithGradNormCount as NativeScaler
import modeling_ddrvq
import utils
...
def get_args():
    ...
    parser.add_argument('--input_size', default=6000, type=int, help='EEG input size for backbone')
...
def main(args):
    ...
    if args.disable_eval:
        ...
        val_datasets = [utils.H5AggregatedDataset(h5_path) for h5_path in val_h5_files]
        dataset_val = ConcatDataset(val_datasets)
        dataset_val_list = [dataset_val]
        val_ch_names_list = [val_datasets[0].get_ch_names()]
