...
def get_dataset(args):
    if args.dataset == 'TUAB':
        train_dataset, test_dataset, val_dataset = utils.prepare_TUAB_dataset("path")
        ch_names = ["FP1-F7", "F7-T7", "T7-P7", "P7-O1", "FP2-F8", "F8-T8", "T8-P8", "P8-O2", "FP1-F3", "F3-C3", "C3-P3", "P3-O1", "FP2-F4", "F4-C4", "C4-P4", "P4-O2"]
        ch_names = [name.split(' ')[-1].split('-')[0] for name in ch_names]
        args.nb_classes = 1
        metrics = ["pr_auc", "roc_auc", "accuracy", "balanced_accuracy"]
    elif args.dataset == 'TUEV':
        train_dataset, test_dataset, val_dataset = utils.prepare_TUEV_dataset("path")
        ch_names = ["FP1-F7", "F7-T7", "T7-P7", "P7-O1", "FP2-F8", "F8-T8", "T8-P8", "P8-O2", "FP1-F3", "F3-C3", "C3-P3", "P3-O1", "FP2-F4", "F4-C4", "C4-P4", "P4-O2"]
        ch_names = [name.split(' ')[-1].split('-')[0] for name in ch_names]
        args.nb_classes = 6
        metrics = ["accuracy", "balanced_accuracy", "cohen_kappa", "f1_weighted"]
    elif args.dataset == "Physio":
        train_dataset, test_dataset, val_dataset = utils.prepare_Physio_dataset(
            "path"
        )
        ...
        train_dataset, test_dataset, val_dataset = utils.prepare_BCICIV2a_dataset("path")
        ch_names = [
        ...
        train_dataset, test_dataset, val_dataset = utils.prepare_MentalArithmetic_dataset("path")
        ch_names = [
        ...
        train_dataset, test_dataset, val_dataset = utils.prepare_SEEDV_dataset("path")
        ch_names = [
        ...
        train_dataset, test_dataset, val_dataset = utils.prepare_Shu_dataset("path")
        ch_names = [
        ...
        train_dataset, test_dataset, val_dataset = utils.prepare_CHBMIT_dataset(
            "path"
        )
        ch_names = ['FP1', 'F7', 'T7', 'P7', 'O1', 'FP2', 'F8', 'T8', 
                'P8', 'O2', 'F3', 'C3', 'P3', 'F4', 'C4', 'P4']
        args.nb_classes = 1 
        metrics = ["pr_auc", "roc_auc", "accuracy", "balanced_accuracy"]
