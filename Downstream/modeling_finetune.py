...
class NeuralTransformer(nn.Module):
    def __init__(self, EEG_size=6000, patch_size=200, in_chans=1, out_chans=8, num_classes=1000, embed_dim=200, depth=12,
...
@register_model
def brainrvq_base_patch200_200(pretrained=False, **kwargs):
